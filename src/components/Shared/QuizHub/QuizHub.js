        ...
        <div>
            ...
            <div className="flex gap-2 flex-col lg:flex-row">
                <div className=''>
                    ...
                    <div>
                        <p className='my-5 mx-10'><span className='text-xl font-bold'>Project Features: </span>Quiz Hub is a fully responsive web application, where someone can play quizzes about React, JavaScript, CSS, and Git. For the play quiz users have to log in first, If a user clicks on a wrong answer it would provide a false answer alert and If a user clicks on a right answer it would provide a right answer alert. We use an eye button to know the correct answer.</p>
